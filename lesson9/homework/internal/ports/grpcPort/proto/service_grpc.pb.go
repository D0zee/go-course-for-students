...
const (
	...
	AdService_AdsByTitle_FullMethodName     = "/ad.AdService/AdsByTitle"
	AdService_CreateUser_FullMethodName     = "/ad.AdService/CreateUser"
	AdService_GetUser_FullMethodName        = "/ad.AdService/GetUser"
	AdService_ChangeUser_FullMethodName     = "/ad.AdService/ChangeUser"
...
type AdServiceClient interface {
	...
	AdsByTitle(ctx context.Context, in *AdsByTitleRequest, opts ...grpc.CallOption) (*ListAdResponse, error)
	CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UserResponse, error)
	GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*UserResponse, error)
	ChangeUser(ctx context.Context, in *ChangeUserRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *adServiceClient) AdsByTitle(ctx context.Context, in *AdsByTitleRequest, opts ...grpc.CallOption) (*ListAdResponse, error) {
	out := new(ListAdResponse)
	err := c.cc.Invoke(ctx, AdService_AdsByTitle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adServiceClient) ChangeUser(ctx context.Context, in *ChangeUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, AdService_ChangeUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdServiceServer interface {
	...
	AdsByTitle(context.Context, *AdsByTitleRequest) (*ListAdResponse, error)
	CreateUser(context.Context, *CreateUserRequest) (*UserResponse, error)
	GetUser(context.Context, *GetUserRequest) (*UserResponse, error)
	ChangeUser(context.Context, *ChangeUserRequest) (*UserResponse, error)
...
func (UnimplementedAdServiceServer) AdsByTitle(context.Context, *AdsByTitleRequest) (*ListAdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AdsByTitle not implemented")
}
...
func (UnimplementedAdServiceServer) ChangeUser(context.Context, *ChangeUserRequest) (*UserResponse, error) {
...
func _AdService_AdsByTitle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdsByTitleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdServiceServer).AdsByTitle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdService_AdsByTitle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdServiceServer).AdsByTitle(ctx, req.(*AdsByTitleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AdService_ChangeUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdServiceServer).ChangeUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdService_ChangeUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdServiceServer).ChangeUser(ctx, req.(*ChangeUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AdsByTitle",
			Handler:    _AdService_AdsByTitle_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _AdService_ChangeUser_Handler,
		},
		{
